...
> **Exam Tip:** For AWT/Swing questions, always draw the **class hierarchy** and explain the **Delegation Event Model** with a diagram showing Source → Event Object → Listener.
